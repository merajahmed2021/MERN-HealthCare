...
const AppointmentfinalScreen = ({navigation,route}) => {
  ...
  console.log(route.params?.appointment_data);
  const data=route.params?.appointment_data;
    ...
    .patient-container{
      ...
      <div class="doctor-container">
        <div class="container-box">
           ...
           <p style="margin-left:20px;">${data.doctor_name}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Hospital Name : </p>
           <p style="margin-left:20px;">${data.hospital_name}</p>
        </div>
      </div>
      <div class="patient-container">
        ...
        <div class="container-box">
           ...
           <p style="margin-left:20px;">${data.patient_name}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Email: </p>
           <p style="margin-left:20px;">${data.email}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Mobile Number: </p>
           <p style="margin-left:20px;">${data.mobileno}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Address: </p>
           <p style="margin-left:20px;">${data.address}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Gender : </p>
           <p style="margin-left:20px;">${data.gender}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Date of Birth: </p>
           <p style="margin-left:20px;">${data.date_of_birth}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Blood Group : </p>
           <p style="margin-left:20px;">${data.blood_group}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Appointment Mode : </p>
           <p style="margin-left:20px;">${data.appointment_mode}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Appointment Type: </p>
           <p style="margin-left:20px;">${data.appointment_type}</p>
        </div>
        <div class="container-box">
           <p style="font-weight:bolder;">Date of Appointment: </p>
           <p style="margin-left:20px;">${data.date_of_appointment}</p>
        </div>
  ...
  async function share() {
    ...
    return (
      <View style={{backgroundColor:'white',height:height}}>
        ...
        <Title>Dear {data.patient_name}</Title>
