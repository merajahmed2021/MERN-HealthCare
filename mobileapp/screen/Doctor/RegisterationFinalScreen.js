  ...
  async function share() {
    ...
    return (
      <View style={{backgroundColor:'white',height:height}}>
        ...
        <Title>Your Registration was Completed.</Title>
        <Text style={{marginVertical:10}}>You will get your registration number after verification</Text>
        <Text style={{marginVertical:10}}>of the details provided by you on email.</Text>
        <Text style={{marginVertical:10}}>Please download you registration slip for proof.</Text>
